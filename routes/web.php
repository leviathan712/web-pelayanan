...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::prefix('dashboard')->group(function () {
        ...
        Route::get('/settings', [OnlineStatusController::class, 'settingView']);
        Route::post('/set-online-status', [OnlineStatusController::class, 'setOnlineStatus'])->name('set-online-status');
    });
});
Auth::routes();
