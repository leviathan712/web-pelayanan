        ...
        <section class="py-10">
            ...
            <div id="controls-carousel" class="relative w-full" data-carousel="static">
                ...
                <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                    ...
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <div class="ml-36 mt-20">
                            <p class="text-kuning">STRUKTUR ORGANISASI KEPENGURUSAN RW. 09 </p>
                            <p class="text-abu_abu text-5xl font-bold">Muhamad John Kaisen</p>
                            <p class="text-2xl">KETUA RUKUN WARGA. 09</p>
                        </div>
                        <img src={{ Vite::asset('resources/images/person.png') }}
                            class="absolute bg-cover top-0 right-0 pr-20" alt="...">
                    </div>
                    <!-- Item 2 -->
                ...
                <button type="button"
                    ...
                    data-carousel-prev>
                    <span
                        class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-300 dark:bg-gray-800/30 group-hover:bg-gray-300 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
